...
pub const Cpu = struct {
    ...
    pub fn execute(self: *Cpu, opcode: u8, memory: *Memory) void {
        switch (opcode) {
            ...
            0x90 => ops.sub_b(self, memory),
            0x91 => ops.sub_c(self, memory),
            0x92 => ops.sub_d(self, memory),
            0x93 => ops.sub_e(self, memory),
            0x94 => ops.sub_h(self, memory),
            0x95 => ops.sub_l(self, memory),
            0x96 => ops.sub_hli(self, memory),
            0x97 => ops.sub_a(self, memory),
            ...
            0xE0 => ops.ld_nn_a(self, memory),
            0xE1 => ops.pop_hl(self, memory),
            0xE2 => ops.ld_a_from_c(self, memory),
            0xE3 => {},
            0xE4 => {},
            ...
            0xF0 => ops.ld_a_from_c(self, memory),
